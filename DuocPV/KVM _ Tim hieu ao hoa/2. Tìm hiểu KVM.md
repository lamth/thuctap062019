# Tìm hiểu KVM #
## 1. Ảo hóa KVM ## 
- KVM là một giải pháp ảo hóa toàn bộ nguồn mở Linux dành cho phần cứng X86 dựa trên các phần mở rộng ảo hóa (Intel VT hoặc AMD-V). Trong KVM, một máy ảo được triển khai như một quy trình Linux thông thường và được lên lịch bởi một bộ lập lịch Linux tiêu chuẩn, mỗi CPU ảo của máy ảo được triển khai như một quy trình Linux thông thường. Điều này cho phép KMV sử dụng chức năng hiện có của nhân Linux.
